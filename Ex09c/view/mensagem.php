...
<body>
    ...
    if ($sucesso) {
        ?>
        <p><img alt="ícone de sucesso!" src="view/icon/sucess.png" height="20" > Salvo com sucesso!</p>
        <?php

    } else {
        ?>
        <p><img alt="ícone de alerta!" src="view/icon/alert.png" height="20" > Não foi salvo.</p>
        <?php
    }
    ?>
