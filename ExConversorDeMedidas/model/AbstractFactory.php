 ...
 * @author Alison Moura - Acadêmico SI (Adaptação para o exercício de PROGWEB 2018-02)
 *
 * @version 2.3 - 15/Out/2018
 */
...
abstract class AbstractFactory {
    ...
    /**
     * Busca objetos no banco de dados que atendem ao id selecionado.
     * Executa um SQL "Select - From - Where"
     * @param string $id - id da tupla a ser buscado.
    ...
    /**
     * Atualiza um objeto no banco. Executa um SQL "Update ..."
    ...
    /**
     * Remove um objeto no banco. Executa um SQL "Delete from ..."
     * @param string $id - Id do objeto a ser removido.
     * @return boolean - se conseguiu remover ou não.
     */
