...
class ContatoFactory extends AbstractFactory {
  ...
  */
  ...
  /**
  * Método para atualização de um contato no banco de dados
  * @param object - Contato a ser alterado
  * @return boolean - True: deu certo False: deu errado
  */
  ...
  * @return object - contato encontrado pela busca ou null caso nenhum contato seja encontrado
  */
  public function buscarPorEmail(string $param): array {
  ...
  /**
  * Método para remoção de um contato no banco de dados
  * @param object - Contato a ser salvo
  * @return boolean - True: deu certo False: deu errado
  */
  public function remover($obj) {
    ...
    try {
      ...
      $sql = "DELETE FROM tbcontato WHERE id = '" 
      . $contato->getId() . "'";
